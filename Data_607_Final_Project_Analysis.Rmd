...
```{r}
ggplot(data=combined_pm_df[1:25, ], aes(x=reorder(PLAYER_NAME, -diff), y=diff)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
  labs(title="NBA Playoffs Player Plus/Minus Diff",
       y="Plus/Minus",
       x="Player") +
  coord_flip()
```
...
ggplot(data=combined_ftpct_df, aes(x=reorder(PLAYER_NAME, -diff), y=diff)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
  labs(title="Player Free Throw Percentage Difference (Minimum 25 Free Throw Attempts)",
       y="Plus/Minus",
       x="Player") +
  coord_flip()
```
...
```{r}
ggplot(data=combined_win_pct_df[62:82, ], aes(x=reorder(PLAYER_NAME, -diff), y=diff)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
